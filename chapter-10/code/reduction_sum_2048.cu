// nvcc reduction_sum_2048.cu -o reduction_sum_2048
...
int main(int argc, char const *argv[]) {
   ...
   float convergent_parallel_reversed_time = benchmark_sum_reduction(covergent_parallel_sum_reduction_reversed, numbers, length);
